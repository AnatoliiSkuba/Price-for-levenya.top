...
// const filePath = path.join(__dirname, 'csv', 'TSGoodsCSV.csv');
// const filePath2 = path.join(__dirname, 'csv', 'TSGoodsCSVNew.csv');

// const watcher = chokidar.watch('csv/TSGoodsCSV.csv', {
...
//   const csvNewOld = data.toString()
  // const goodsParsed = Papa.parse(csvNewOld, { header: true });
  // console.log(goodsParsed);

  // const csvNew = Papa.unparse(goodsParsed.data);

//   fs.writeFile(filePath2, csvNewOld, err => {
//       if (err) { throw err };
//     });
...
try {
  ...
  // const x2js = new X2JS();
  //   const jsonObj = x2js.xml2js(data);
    // console.log(content);
    // console.log(jsonObj);

  // const xml3 = xml2.replace(/Майка/gi, "Майка+++")
